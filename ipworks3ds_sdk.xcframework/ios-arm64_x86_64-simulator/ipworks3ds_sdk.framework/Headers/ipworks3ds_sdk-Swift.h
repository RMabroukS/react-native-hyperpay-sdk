...
SWIFT_CLASS("_TtC14ipworks3ds_sdk12PkgInfoNameA")
@interface PkgInfoNameA : NSObject <CloseAllSelectionStyle>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)pointeeSetTextFontSize:(NSData * _Null_unspecified)dataPacket;
- (void)jmpOffsetRadius:(NSData * _Null_unspecified)dataPacket;
- (void)nibNameSocket:(int32_t)errorCode :(NSString * _Null_unspecified)description;
- (void)imageWidthCanOpenURL:(int32_t)logLevel :(NSString * _Null_unspecified)message :(NSString * _Null_unspecified)logType;
- (void)primaryActionTriggeredInline:(NSData * _Null_unspecified)certEncoded :(NSString * _Null_unspecified)certSubject :(NSString * _Null_unspecified)certIssuer :(NSString * _Null_unspecified)status :(int32_t * _Nonnull)accept;
- (void)strtoulTitleTextAttributes:(NSString * _Null_unspecified)message;
@end
...
SWIFT_CLASS("_TtC14ipworks3ds_sdk19ViewWithTagTearDown")
@interface ViewWithTagTearDown : NSObject
+ (void)minutesFromGMTUnselectedIcon;
+ (void)ensurePresentImagAddrStart;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
